Examen 2 - Multimèdia i integració (CSS + embed + multimèdia)
Instruccions Generals
Llegeix tot l’enunciat abans de començar
Utilitza només CSS pur (sense frameworks com Tailwind o Bootstrap)
Assegura’t que totes les animacions funcionen correctament
Prova les animacions en diferents navegadors si és possible
Objectiu
Crear una pàgina web interactiva que demostri el domini de transicions, transformacions i animacions CSS. La pàgina haurà de contenir diversos elements amb diferents tipus d’animacions i efectes.
...
Crea un únic fitxer index al teu repositori “apellidos_nombre_examen-animaciones”